...
Switch to [express-urlrewrite](https://github.com/kapouer/express-urlrewrite) to support rewriting query parameters (e.g.  `/articles?type=1 # → /posts/1`)
...
* Fix [#396](https://github.com/typicode/json-server/issues/396) PUT/PATCH saves the updated item with an type that has been converted to string
