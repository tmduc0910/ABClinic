	...
	"links": [{
		...
		"href": "comments/?id={id}"
            ...
            <section title="Terminology">
                <t>
                    ...
                    denote a JSON Schema
                    definition, and an <spanx style="strong">instance</spanx> refers to a JSON value
                    that the schema
        ...
        <section title="Schema/Instance Association">
            <t>
                ...
                representation should specify the relation to the schema is beyond the normative
                scope
                ...
                "profile" or a relation of "describedby" (which could be defined by a Link header)
                may be used:
...
Link: <http://json.com/my-hyper-schema>; rel="describedby"
            ...
            <section title="Self-Descriptive Schema">
                <t>
                    ...
                    <eref target="http://json-schema.org/draft-03/schema">
                ...
                <t>
                    ...
                    <list style="hanging">
                        <t hangText="Simple Types">
                            ...
                            <list style="hanging">
                                ...
                                <t hangText="null">Value MUST be null. Note this is mainly for
                                    purpose of being able use union type to define nullability. If
                                    this type is not included in a union, null values are not
                                    allowed (the primitives listed above do not allow nulls on their
                                    own).
                                </t>
                        ...
                        <t hangText="Union Types">
                            ...
                            MUST be a simple type definition or a schema.
                            The instance value is valid if it is of the same type as one of the
                            simple type definitions, or valid by one of the schemas, in the array.
                        </t>
                    </list>
                </t>
	...
	"type": ["string", "number"]
            ...
            <section anchor="properties" title="properties">
                <t>This attribute is an object with property definitions that define the valid
                    values of instance object property values. When the instance value is an object,
                    the property values of the instance object MUST conform to the property
                    definitions in this object. In this object, each property definition's value
                    MUST be a schema, and the property's name MUST be the name of the instance
                    property that it defines. The instance property value MUST be valid according to
                    the schema from the property definition. Properties are considered unordered,
                    the order of the instance properties MAY be in any order.
                </t>
            </section>
            ...
            <section anchor="additionalProperties" title="additionalProperties">
                <t>This attribute defines a schema for all properties that are not explicitly
                    defined in an object type definition. If specified, the value MUST be a schema
                    or a boolean. If false is provided, no additional properties are allowed beyond
                    the properties defined in the schema. The default value is an empty schema which
            ...
            <section title="items">
                <t>This attribute defines the allowed items in an instance array, and MUST be a
                    schema or an array of schemas. The default value is an empty schema which allows
                    any value for items in the instance array.
                </t>
                ...
                <t>When this attribute value is an array of schemas and the instance value is an
                    ...
                    corresponding position for this array. This called tuple typing. When tuple
                    typing is used, additional items are allowed, disallowed, or constrained by the <xref
                        target="additionalItems">"additionalItems"
                    </xref> attribute using the same rules as <xref target="additionalProperties">
            ...
            <section anchor="additionalItems" title="additionalItems">
                <t>This provides a definition for additional items in an array instance when tuple
                    definitions of the items is provided. This can be false to indicate additional
                    items in the array are not allowed, or it can be a schema that defines the
                    schema of the additional items.
                </t>
            </section>
                ...
                <t>
                    ...
                    <list>
                        ...
                        <t>are arrays, contains the same number of items, and each item in the array
                            is equal to the corresponding item in the other array; or
                        </t>
            ...
            <section title="format">
                <t>This property defines the type of data, content type, or microformat to be
                    ...
                    values listed below, and if so, SHOULD adhere to the semantics describing for
                    the format. A format SHOULD only be used to give meaning to primitive type
                    (string, integer, number, or boolean). Validators MAY (but are not required to)
                ...
                <t>
                    ...
                    <list style="hanging">
                        ...
                        <t hangText="date">This SHOULD be a date in the format of YYYY-MM-DD. It is
                            recommended that you use the "date-time" format instead of "date" unless
                            you need to transfer only the date part.
                        </t>
                        <t hangText="time">This SHOULD be a time in the format of hh:mm:ss. It is
                            recommended that you use the "date-time" format instead of "time" unless
                            you need to transfer only the time part.
                        </t>
                        <t hangText="utc-millisec">This SHOULD be the difference, measured in
                            milliseconds, between the specified time and midnight, 00:00 of January
                            1, 1970 UTC. The value SHOULD be a number (integer or float).
                        </t>
                        ...
                        <t hangText="style">This is a CSS style definition (like "color: red;
                            background-color:#FFF"), based on <xref target="W3C.CR-CSS21-20070719">
                                CSS 2.1</xref>.
                        </t>
                ...
                <t>Additional custom formats MAY be created. These custom formats MAY be expressed
                    as an URI, and this URI MAY reference a schema of that format.
                </t>
            </section>
            ...
            <section anchor="links" title="links">
                ...
                <section title="Link Description Object">
                    <t>
                        ...
                        (latest version) or
                        <eref target="http://json-schema.org/draft-03/links">
	...
	"foo": {
		...
		"another prop": {
			"baz": "A string"
                        ...
                        <figure>
                            <preamble>The following fragment identifiers would be resolved:
                            </preamble>
                            <artwork>
                                <![CDATA[
...
#/foo/anArray/0          the first object in the "anArray" array
                ...
                <section title="dot-delimited fragment resolution">
                    <t>
                        ...
                        the path does not need to start with a ".". For example, #.foo and #foo are
                        a valid fragment
            ...
            <section title="readonly">
                <t>This attribute indicates that the instance property SHOULD NOT be changed.
...
[{
    ...
    <back>
        ...
        <references title="Normative References">
            &rfc2045; &rfc2119; &rfc2396; &rfc3339; &rfc3986; &rfc4287;
        </references>
        ...
        <section title="Open Issues">
            <t>
                <list>
                    <t>Should we give a preference to MIME headers over Link headers (or only use
                        one)?
                    </t>
                    <t>Should "root" be a MIME parameter?</t>
                    <t>Should "format" be renamed to "mediaType" or "contentType" to reflect the
                        usage MIME media type that are allowed?
                    </t>
