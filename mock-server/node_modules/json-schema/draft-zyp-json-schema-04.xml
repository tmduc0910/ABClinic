<?xml version="1.0" encoding="US-ASCII"?><!DOCTYPE rfc SYSTEM
    "rfc2629.dtd" [<!ENTITY rfc4627 SYSTEM "http://xml.resource.org/public/rfc/bibxml/reference.RFC.4627.xml"><!ENTITY rfc3986 SYSTEM "http://xml.resource.org/public/rfc/bibxml/reference.RFC.3986.xml"><!ENTITY rfc2119 SYSTEM "http://xml.resource.org/public/rfc/bibxml/reference.RFC.2119.xml"><!ENTITY rfc4287 SYSTEM "http://xml.resource.org/public/rfc/bibxml/reference.RFC.4287.xml"><!ENTITY rfc2616 SYSTEM "http://xml.resource.org/public/rfc/bibxml/reference.RFC.2616.xml"><!ENTITY rfc3339 SYSTEM "http://xml.resource.org/public/rfc/bibxml/reference.RFC.3339.xml"><!ENTITY rfc2045 SYSTEM "http://xml.resource.org/public/rfc/bibxml/reference.RFC.2045.xml"><!ENTITY rfc5226 SYSTEM "http://xml.resource.org/public/rfc/bibxml/reference.RFC.5226.xml"><!ENTITY iddiscovery SYSTEM "http://xml.resource.org/public/rfc/bibxml3/reference.I-D.hammer-discovery.xml"><!ENTITY uritemplate SYSTEM "http://xml.resource.org/public/rfc/bibxml3/reference.I-D.gregorio-uritemplate.xml"><!ENTITY linkheader SYSTEM "http://xml.resource.org/public/rfc/bibxml3/reference.I-D.nottingham-http-link-header.xml"><!ENTITY html401 SYSTEM "http://xml.resource.org/public/rfc/bibxml4/reference.W3C.REC-html401-19991224.xml"><!ENTITY css21 SYSTEM "http://xml.resource.org/public/rfc/bibxml4/reference.W3C.CR-CSS21-20070719.xml">]><?rfc toc="yes"?><?rfc symrefs="yes"?><?rfc compact="yes"?><?rfc subcompact="no"?><?rfc strict="no"?><?rfc rfcedstyle="yes"?>
    ...
    <front>
        ...
        <abstract>
            <t>
                ...
                a JSON based format for defining the structure of JSON data. JSON Schema provides a
                contract for what JSON
    ...
    <middle>
            ...
            <t>
                ...
                <list style="hanging">
                    ...
                    <t hangText="instance">Equivalent to "JSON value" as defined in <xref
                        target="RFC4627">RFC 4627</xref>.
                    </t>
                    <t hangText="property">Equivalent to "member" as defined in <xref
                        target="RFC4627">RFC 4627</xref>.
                    </t>
                    <t hangText="item">Equivalent to "element" as defined in <xref target="RFC4627">
                        RFC 4627</xref>.
                    </t>
        ...
        <section title="Overview">
            <t>
                ...
                describing the structure of JSON text. JSON Schemas are also written in JSON and
                includes facilities
	...
	"links": [{
		...
		"href": "comments/?id={id}"
            ...
            <section title="Design Considerations">
                ...
                <t>
                    ...
                    representations from a large variety of services that leverage a
        ...
        <section title="Schema/Instance Association">
            <t>
                ...
                and retain the self-descriptive characteristics. This avoides the need for
                out-of-band information about
                instance data. Two approaches are recommended for declaring the
                relation to the schema that describes the meaning of a JSON instance's (or
                collection
...
Link: <http://example.com/my-hyper-schema>; rel="describedby"
            ...
            <section title="Self-Descriptive Schema">
                <t>
                    ...
                    be found at <eref target="http://json-schema.org/schema">
                    http://json-schema.org/schema
                </eref> for the latest version or
                    <eref target="http://json-schema.org/draft-04/schema">
                        http://json-schema.org/draft-04/schema
                    </eref>
                    for the draft-04 version. The hyper schema
                    self-description can be found at
                    <eref target="http://json-schema.org/hyper-schema">
                    ...
                    used within a protocol with a media type specified SHOULD include a MIME
                    parameter that refers to the self-descriptive
                    ...
                    <![CDATA[
{
	...
	"properties": {
		...
		"age": {
            ...
            <!-- TODO: Break attributes up into type section -->
            ...
            <section anchor="type" title="type">
                <t>
                    ...
                    MUST be in order to validate.
                    This attribute can take one of two forms:

                    <list style="hanging">
                        <t hangText="Simple Types">
                            A string indicating a primitive or simple type. The string MUST be one
                            ...
                            <list style="hanging">
                                ...
                                <t hangText="null">Instance MUST be the JSON literal "null". Note
                                    that without this type, null values are not allowed.
                                </t>
                        ...
                        <t hangText="Union Types">
                            An array of one or more simple or schema type.
                            The instance value is valid if it is of the same type as one of the
                            simple type, or valid by one of the schemas, in the array.
                        </t>
                    </list>

                    If this attribute is not specified, then all value type are accepted.
                </t>
                        ...
                        <![CDATA[
{
	"type": ["string", "number"]
            ...
            <section anchor="properties" title="properties">
                <t>
                    This attribute is an object with properties that specify the schemas for the
                    properties of the instance object.
                    In this attribute's object, each property value MUST be a schema.
                    When the instance value is an object, the value of the instance's properties
                    MUST be valid according to the schemas with the same property names specified in
                    this attribute.
                    Objects are unordered, so therefore the order of the instance properties or
                    attribute properties MUST NOT determine validation success.
                </t>
            </section>

            <section anchor="patternProperties" title="patternProperties">
                <t>
            ...
            <section anchor="additionalProperties" title="additionalProperties">
                <t>This attribute specifies how any instance property that is not explicitly defined
                    by either the <xref target="properties">"properties"</xref> or <xref
                        target="patternProperties">"patternProperties"
                    </xref> attributes (hereafter referred to as "additional properties") is
                    handled. If specified, the value MUST be a schema or a boolean.
                </t>
                <t>If a schema is provided, then all additional properties MUST be valid according
                    to the schema.
                </t>
            ...
            <section anchor="items" title="items">
                <t>This attribute provides the allowed items in an array instance. If specified,
                    this attribute MUST be a schema or an array of schemas.
                </t>
                ...
                <t>When this attribute value is an array of schemas and the instance value is an
                    array, each position in the instance array MUST be valid according to the schema
                    in the corresponding position for this array. This called tuple typing. When
                    tuple typing is used, additional items are allowed, disallowed, or constrained
                    by the <xref target="additionalItems">"additionalItems"</xref> attribute the
                    same way as <xref target="additionalProperties">"additionalProperties"</xref> for
                    objects is.
                </t>
            </section>

            <section anchor="additionalItems" title="additionalItems">
                <t>This attribute specifies how any item in the array instance that is not
                    explicitly defined by <xref target="items">"items"</xref> (hereafter referred to
                    as "additional items") is handled. If specified, the value MUST be a schema or a
                    boolean.
                </t>
                <t>If a schema is provided:
                    <list>
                        <t>If the <xref target="items">"items"</xref> attribute is unspecified, then
                            all items in the array instance must be valid against this schema.
                        </t>
                        <t>If the <xref target="items">"items"</xref> attribute is a schema, then
                            this attribute is ignored.
                        </t>
                        <t>If the <xref target="items">"items"</xref> attribute is an array (during
                            tuple typing), then any additional items MUST be valid against this
                            schema.
                        </t>
                    </list>
                </t>
            ...
            <section anchor="required" title="required">
                <t>This attribute is an array of strings that defines all the property names that
                    must exist on the object instance.
                </t>
            </section>

            <section anchor="dependencies" title="dependencies">
                <t>This attribute is an object that specifies the requirements of a property on an
                    object instance. If an object instance has a property with the same name as a
                    property in this attribute's object, then the instance must be valid against the
                    attribute's property value (hereafter referred to as the "dependency value").
                </t>
                <t>
                    ...
                    <list style="hanging">
                        <t hangText="Simple Dependency">
                            ...
                            a property with the same name as the dependency value.
            ...
            <section anchor="exclusiveMinimum" title="exclusiveMinimum">
            ...
            <section anchor="exclusiveMaximum" title="exclusiveMaximum">
                <t>This attribute indicates if the value of the instance (if the instance is a
            ...
            <section anchor="minItems" title="minItems">
                <t>This attribute defines the minimum number of values in an array when the array is
                    the instance value.
                </t>
            </section>

            <section anchor="maxItems" title="maxItems">
                <t>This attribute defines the maximum number of values in an array when the array is
                    the instance value.
                </t>
            </section>

            <section anchor="minProperties" title="minProperties">
                <t>This attribute defines the minimum number of properties required on an object
                    instance.
                </t>
            </section>

            <section anchor="maxProperties" title="maxProperties">
                <t>This attribute defines the maximum number of properties the object instance can
                    have.
                </t>
            </section>

            <section anchor="uniqueItems" title="uniqueItems">
                ...
                <t>
                    ...
                    <list>
                        ...
                        <t>are arrays, contains the same number of items, and each item in the array
                            is equal to the item at the corresponding index in the other array; or
                        </t>
            ...
            <section anchor="pattern" title="pattern">
                <t>When the instance value is a string, this provides a regular expression that a
                    string instance MUST match in order to be valid. Regular expressions SHOULD
                    follow the regular expression specification from ECMA 262/Perl 5
                </t>
            </section>

            <section anchor="minLength" title="minLength">
                <t>When the instance value is a string, this defines the minimum length of the
                    string.
                </t>
            </section>

            <section anchor="maxLength" title="maxLength">
            ...
            <section anchor="enum" title="enum">
                <t>This provides an enumeration of all possible values that are valid for the
                    instance property. This MUST be an array, and each item in the array represents
                    a possible value for the instance value. If this attribute is defined, the
                    instance value MUST be one of the values in the array in order for the schema to
                    be valid. Comparison of enum values uses the same algorithm as defined in <xref
            ...
            <section anchor="divisibleBy" title="divisibleBy">
            ...
            <section anchor="disallow" title="disallow">
                <t>This attribute takes the same values as the "type" attribute, however if the
                    instance matches the type or if this value is an array and the instance matches
                    any type or schema in the array, then this instance is not valid.
                </t>
            </section>

            <section anchor="extends" title="extends">
                <t>The value of this property MUST be another schema which will provide a base
                    schema which the current schema will inherit from. The inheritance rules are
                    such that any instance that is valid according to the current schema MUST be
                    valid according to the referenced schema. This MAY also be an array, in which
                    case, the instance MUST be valid for all the schemas in the array. A schema that
                    extends another schema MAY define additional attributes, constrain existing
                            ...
                            <![CDATA[
{
	...
	"extends": {"$ref": "http://json-schema.org/draft-04/schema"}
            ...
            <section anchor="ref" title="$ref">
                <t>
                    This attribute defines a URI of a schema that contains the full representation
                    of this schema.
                    When a validator encounters this attribute, it SHOULD replace the current schema
                    with the schema referenced by the value's URI (if known and available) and
                    re-validate the instance.
                    This URI MAY be relative or absolute, and relative URIs SHOULD be resolved
            ...
            <section anchor="schema" title="$schema">
                <t>
                    ...
                    schema.
                    When this attribute is defined, a validator SHOULD use the schema referenced by
                    the value's URI (if known and available) when resolving
                ...
                <t>
                    ...
                    Therefore, it is RECOMMENDED that all schema authors include this attribute in
                    their schemas to prevent conflicts with future JSON Schema specification
                    changes.
                </t>
            </section>
        </section>

        <section anchor="hyper-schema" title="Hyper Schema">
            <t>
            ...
            <section anchor="links" title="links">
                ...
                <section title="Link Description Object">
                    <t>
                        ...
                        <eref target="http://json-schema.org/links">http://json-schema.org/links
                        </eref>
                        (latest version) or
                        <eref target="http://json-schema.org/draft-04/links">
                    ...
                    <section anchor="href" title="href">
                        <t>
                            ...
                            when used within a schema. Also, when links are used within a schema,
                            the URI
                            ...
                            in the template (otherwise they MAY be provided from alternate sources,
                            like user input).
                        </t>
                        ...
                        <t>
                            ...
                            characters,
                            creating an expanded URI. Instance property value substitutions are
                            resolved
...
http://somesite.com/45
                            ...
                            a property value.
                            This should only be used in situations where the instance is a scalar
                            (string,
                    ...
                    <section title="rel">
                        <t>
                            ...
                            relation to the target resource. The relation to the target SHOULD be
                            interpreted as specifically from the instance object that the schema (or
                            sub-schema) applies to, not just the top level resource that contains
                            the object within its hierarchy. If a resource JSON representation
                            contains a sub object with a property interpreted as a link, that
                            sub-object holds the relation with the target. A relation to target from
                            the top level resource MUST be indicated with the schema describing the
                        ...
                        <t>
                            ...
                            <list style="hanging">
                                <t hangText="self">
                                    ...
                                    encountered in
                                    the instance object, the object represents a resource and the
                                    instance object is
                                    treated as a full representation of the target resource
                                    identified by
                                    the specified URI.
                                </t>
                                ...
                                <t hangText="root">
                                    ...
                                    SHOULD be treated as the root or the body of the representation
                                    for the
	...
	"upId": "parent"
                    ...
                    <section title="template">
                        <t>This property value is a string that defines the templating language used
                            ...
                            language is defined, then the default <xref target="href">Link
                    ...
                    <section title="Submission Link Properties">
                        <t>
                            ...
                            means for submitting extra (often user supplied) information to send to
                            a server.
                        </t>
                        ...
                        <section title="enctype">
                            <t>
                                ...
                                the server
                                supports for querying or posting to the collection of instances at
                                the target
                                resource. The query can be
                                suffixed to the target URI to query the collection with
                                property-based constraints on the resources that SHOULD be returned
                                from
                                the server or used to post data to the resource (depending on the
                                method).
...
/Product/?name=Slinky
                        ...
                        <section title="schema">
                            <t>
                                ...
                                request (for a GET request, this schema would define the properties
            ...
            <section title="fragmentResolution">
                ...
                <section title="json-pointer fragment resolution">
                    <t>The "json-pointer" fragment resolution protocol uses a <xref
                        target="json-pointer">JSON Pointer
            ...
            <section title="readonly">
                <t>This attribute indicates that the instance value SHOULD NOT be changed. Attempts
                    by a user agent to modify the value of this property are expected to be rejected
                    by a server.
                </t>
            </section>
            ...
            <section title="contentEncoding">
                <t>If the instance property value is a string, this attribute defines that the
                    string SHOULD be interpreted as binary data and decoded using the encoding named
                    by this schema property. <xref target="RFC2045">RFC 2045, Sec 6.1</xref> lists
            ...
            <section title="pathStart">
                <t>
                    ...
                    order to validate.
                    The value of the "pathStart" attribute MUST be resolved as per <xref
                    target="RFC3986">RFC 3986, Sec 5</xref>,
                ...
                <t>
                    ...
                    or if another schema specifies a starting URI that is longer and also matches
                    the
        ...
        <section title="Security Considerations">
            <t>
                ...
                consequently the security considerations are generally the same as <xref
                target="RFC4627">RFC 4627</xref>.
...
[{
	...
	"name": "This representation\
        ...
        <section title="IANA Considerations">
            ...
            <section title="Registry of Link Relations">
                <t>
                    This registry is maintained by IANA per <xref target="RFC4287">RFC 4287</xref> and
                    this specification adds
                    four values: "full", "create", "instances", "root". New
                    assignments are subject to IESG Approval, as outlined in <xref target="RFC5226">
                    RFC 5226</xref>.
    ...
    <back>
        ...
        <references title="Normative References">
            &rfc2045; &rfc2119; &rfc3339; &rfc3986; &rfc4287;
        ...
        <references title="Informative References">
            &rfc2616; &rfc4627; &rfc5226; &iddiscovery; &uritemplate; &linkheader; &html401; &css21;
        </references>
                ...
                <list style="hanging">
                    <t hangText="draft-04">
                        <list style="symbols">
                            ...
                            <t>Replaced "slash-delimited" fragment resolution with "json-pointer".
                            </t>
                            <t>Added "template" LDO attribute.</t>
                            <t>Removed irrelevant "Open Issues" section.</t>
                            <t>Merged Conventions and Terminology section.</t>
                            <t>Defined terms used in specification.</t>
                            <t>Removed "integer" type in favor of {"type":"number",
                                "divisibleBy":1}.
                            </t>
                            <t>Restricted "type" to only the core JSON type.</t>
                            <t>Improved wording of many section.</t>
                        </list>
                    </t>
