...
* `options` - (Object) Optional uuid state to apply. Properties may include:
  ...
  * `node` - (Array) Node type as Array of 6 bytes (per 4.1.6). Default: Randomly generated ID.  See note 1.
...
Note: The <node> type is generated guaranteed to stay constant for the lifetime of the current JS runtime. (Future versions of this module may use persistent storage mechanisms to extend this guarantee.)
