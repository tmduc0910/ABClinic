# jsprim: utilities for primitive JavaScript type

This module provides miscellaneous facilities for working with strings,
numbers, dates, and objects and arrays of these basic type.


### deepCopy(obj)

Creates a deep copy of a primitive type, object, or array of primitive type.
...
Parses the contents of `str` (a string) as an integer. On status, the integer
...
schema.  On status, returns null.  On failure, *returns* (does not throw) a
useful Error object.
