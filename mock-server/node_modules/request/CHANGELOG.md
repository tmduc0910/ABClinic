...
- [#1876](https://github.com/request/request/pull/1876) Implement loose matching for har mime type (@simov)
...
- [#1388](https://github.com/request/request/pull/1388) Upgrade mime-type package version (@roderickhsiao)
...
- [#512](https://github.com/request/request/pull/512) Make password optional to support the format: http://account@hostname/ (@pajato1)
