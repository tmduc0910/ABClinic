...
===================
  ...
  * deps: send@0.16.0
    - Add 70 new type for file extensions
...
===================
  ...
  * Use `%o` in path debug to tell type apart
...
==================
  ...
  * Added route `Collection`, ex: `app.get('/user/:type').remove();`
...
==================
  ...
  * Added `app.lookup.VERB()`, ex `app.lookup.put('/user/:type')`. Closes #606
...
==================
  ...
  * Fixed bug preventing Opera from retaining the generated session type. Closes #292
