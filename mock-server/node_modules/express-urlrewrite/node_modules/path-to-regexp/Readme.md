...
```js
var toPath = pathToRegexp.compile('/user/:type')

toPath({ type: 123 }) //=> "/user/123"
toPath({ type: 'café' }) //=> "/user/caf%C3%A9"
toPath({ type: '/' }) //=> "/user/%2F"

toPath({ type: ':' }) //=> "/user/%3A"
toPath({ type: ':' }, { pretty: true }) //=> "/user/:"
...
var toPathRegexp = pathToRegexp.compile('/user/:type(\\d+)')

toPathRegexp({ type: 123 }) //=> "/user/123"
toPathRegexp({ type: '123' }) //=> "/user/123"
toPathRegexp({ type: 'abc' }) //=> Throws `TypeError`.
```
