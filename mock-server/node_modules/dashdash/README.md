...
var options = [
    {
        ...
        names: ['help', 'h'],
        // See "Option specs" below for type.
        type: 'bool',
...
- Custom optarg and arg type for custom completions.
...
option type. Also see [node-cmdln](https://github.com/trentm/node-cmdln) for
how it uses this for Bash completion for full multi-subcommand tools.

- TODO: document specExtra
- TODO: document includeHidden
- TODO: document custom type, `function complete\_FOO` guide, completionType
...
- `type` (String). Required. One of:
  ...
  You can add your own custom option type with `dashdash.addOptionType`.
  See below.
...
Dashdash includes a good starter set of option type that it will parse for
