...
public class GetUserInfoTask extends CustomAsyncTask<UserInfo, Void, UserEntity> {
    private AppDatabase appDatabase;

    public GetUserInfoTask(AppDatabase appDatabase, Context context, String storageKey, AsyncResponse<UserEntity> delegate) {
