...
public class DialogAdaptor extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView name_history = listViewItem.findViewById(R.id.name_history);
        TextView time_history = listViewItem.findViewById(R.id.hour_history);

        ImageView image_history = listViewItem.findViewById(R.id.image_history);
