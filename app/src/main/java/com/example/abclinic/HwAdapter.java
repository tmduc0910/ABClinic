...
class HwAdapter extends BaseAdapter {
    ...
    public HwAdapter(Activity context, GregorianCalendar monthCalendar, ArrayList<HighlightEvent> date_collection_arr) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        dayView = (TextView) v.findViewById(R.id.date);// gia dien cua so
                            ...
                            if (len1>pos) {
                                ...
                                if (day_string.get(pos).equals(date)) {
                                    if ((Integer.parseInt(gridvalue) > 1) && (pos < firstDay)) {
                                        ...
                                        if ( HighlightEvent.date_collection_arr.get(i).seen == false ) {
