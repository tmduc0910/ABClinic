...
public class CustomEventDay extends EventDay {
    ...
    public enum IconType {
        INQUIRY(R.drawable.ic_dot_green, 0),
        RECORD(R.drawable.ic_dot_blue, 1),
        REPLY(R.drawable.ic_dot_purple, 2),
        SCHEDULE(R.drawable.ic_schedule_red, 3);

        private int resourceId;
        private int value;

        IconType(int resourceId, int value) {
